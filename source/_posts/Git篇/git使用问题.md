...
categories: Git篇
keywords:
description: Git 不仅仅是个版本控制系统，它也是个内容管理系统(CMS)，工作管理系统等.如果你是一个具有使用 SVN 背景的人，你需要做一定的思想转换，来适应 Git 提供的一些概念和特征.
comments:
cover: https://img.wallpapersafari.com/desktop/1920/1080/41/23/i1MQ0o.jpg
toc:
toc_number:
toc_style_simple:
copyright:
...
1. .gitignore 不生效的原因: 文件曾经被`track`过，所以不会被 ignore
   **解决方法：**
